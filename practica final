...
<img src="https://cacm.acm.org/system/assets/0001/7595/102114_Gaurang_JavaScript-and-the.large.jpg?1476779478&1413913211" alt="Cuadrados rojos">
<H1>JAVASCRIPT</H1>
...
<H1>PROGRESSIVE WEB APPS</H1>
 ...
 Hace ahora unos meses que las Progressive Web Apps han llegado en el mundo de la web y del móvil pero, ¿conoces realmente<br>
...
<h1><li>Machine Learning.</li></h1> <p>
 ...
 a Arthur Samuel en 1959, le da a las computadoras la habilidad de aprender sin ser explícitamente<br>
...
Tras el concepto deep learning se encuentra un grupo de algoritmos que imita al cerebro humano ‘aprendiendo’<br>
...
<H3>Para más información hacer click:"Red Neuronal
". </H3>
<ol>
...
<li><a href="https://www.youtube.com/watch?v=wHiRYTcHNj8" target="_blank">CRIPTOMONEDAS</a></li>
...
La realidad aumentada es diferente de la realidad virtual: sobre la realidad material del mundo<br>
...
El término realidad mixta no debe confundirse con el de realidad aumentada o RA. La realidad<br>
...
Kevin Ashton, cofundador y director ejecutivo del Auto-ID Center de MIT, mencionó<br>
...
<ol>
<li><a href="https://www.youtube.com/watch?v=uhgTgSHJXU8" target="_blank">MECATRÓNICA</a></li>
...
<img src="https://cdn.cnn.com/cnnnext/dam/assets/180326200422-cnndinero-5g-technology-t1-main.jpg" alt="Cuadrados rojos"> 
<H1>TECNOLOGIA 5G</H1>
...
<br><br><br>
<H3>JAVASCRIPT</H3>
La estandarización de Javascript comenzó en conjunto con ECMA en Noviembre de 1996. Es<br>
adoptado este estándar en Junio de 1997 y luego también por la “Internacional <br>
Organization for Standardization” (ISO). El DOM por sus siglas en inglés “Modelo de<br>
Objetos del Documento” fue diseñado para evitar incompatibilidades.

<br><br><br>
<H3>PROGRESSIVE WEB APPS</H3>
Gracias a las Progressive Web Apps, las pequeñas y medianas empresas dispondrán <br>
de una herramienta de bajo coste que aúna los elementos más importantes del <br>
marketing móvil. Podrán crear sistemas de fidelización para retener a sus<br>
 clientes, comunicarse de una manera más directa a través de mensajes Push<br>
 o facilitar las compras y reservas desde el móvil.

<br><br><br>
<H3>INTELIGENCIA ARTIFICIAL</H3>
Inteligencia artificial es el concepto para máquinas que “piensan como seres<br>
humanos”; en otras palabras, que realizan tareas como: razonar , planificar , aprender<br>
y entender el lenguaje . Nadie espera que en la actualidad, o en un futuro<br>
cercano, una tecnología pueda igualar la inteligencia humana, pero la IA tiene<br>
grandes implicaciones en la forma en que vivimos nuestras vidas.

<br><br><br>
<H3>Machine Learning</H3>
Dado que el machine learning es un sistema basado en el procesamiento y análisis<br>
de datos que son traducidos a hallazgos, se puede aplicar a cualquier campo que<br>
cuente con bases de datos lo suficientemente grandes.


<br><br><br>
<H3>Deep learning</H3>
Existen diferentes arquitecturas de redes de neuronas diferentes, entre las principales<br>
tenemos: la máquina de Boltzmann restringida (RBM), la red de creencia profunda<br>
(DBN), las redes de neuronas convolutivas (CNN), y las redes de neuronas recurrentes (RNN).

<br><br><br>
<H3>Red Neuronal</H3>
Las redes neuronales no son una idea nueva. Datan de los años 40 y 50, cuando se empezaron<br>
a publicar los primeros conceptos. Sin embargo, nunca tuvieron un gran éxito, más que nada<br>
porque se necesita una cantidad importante de recursos de un ordenador para entrenar y<br>
ejecutar una red neuronal con buenos resultados.

<br><br><br>
<H3>CRIPTOMONEDAS</H3>
Minar criptomonedas es el proceso a través del cual las transacciones de<br>
criptomoneda se verifican y se ofrecen nuevas unidades. 

<br><br><br>
<H3>BLOCKCHAIN</H3>
Una cadena de bloques (block chain), también conocida como libro de contabilidad<br>
distribuido (distributed ledger), es una base de datos distribuida que registra<br>
bloques de información y los entrelaza para facilitar la recuperación de la<br>
información y la verificación de que ésta no ha sido cambiada. 

<br><br><br>
<H3>CYBERSEGURIDAD</H3>
En la actualidad, un término ampliamente utilizado es “ciberseguridad”, que puede<br>
asociarse con otras palabras como ciberespacio, ciberamenazas, cibercriminales u<br>
otros conceptos compuestos. Aunque se tiene una percepción general sobre lo que <br>
representa, en ocasiones puede utilizarse como sinónimo de seguridad de la<br>
información, seguridad informática o seguridad en cómputo -pero esta idea no es del todo correcta.

<br><br><br>
<H3>REALIDAD VIRTUAL</H3>
La realidad virtual puede emplearse en la formación de profesionales o como<br> 
entretenimiento, a la manera de un videojuego. La idea es que la persona sienta<br>
que es parte del mundo que observa a través del visor. 

<br><br><br>
<H3>REALIDAD AUMENTADA</H3>
Haz una pregunta La realidad aumentada es una tecnología que complementa el mundo<br>
real con el mundo digital. Superpone imágenes generadas por ordenadores, smartphones,<br>
tabletas o visores especiales a lo que sucede en tiempo real, de modo que el<br> 
usuario tenga una mejor percepción de la realidad.


<br><br><br>
<H3>REALIDAD MIXTA</H3>
Un experto actual en modelado y creación de aplicaciones de VR será capaz de<br>
dominar el desarrollo de realidad mixta. Por lo tanto, formarte en la creación<br>
de experiencias de VR/AR a día de hoy te servirá para poder desarrollar<br> 
realidad mixta en el futuro.

<br><br><br>
<H3>INTERNET DE LAS COSAS</H3>
La internet de las cosas (IoT, por sus siglas en inglés) es un sistema <br>
de dispositivos de computación interrelacionados, máquinas mecánicas y<br> 
digitales, objetos, animales o personas que tienen identificadores únicos<br>
y la capacidad de transferir datos a través de una red, sin requerir de <br>
interacciones humano a humano o humano a computadora.

<br><br><br>
<H3>INTERNET DE LAS COSAS</H3>
Se trata una revolución en las relaciones entre los objetos y las<br>
personas, incluso entre los objetos directamente, que se conectaran<br> 
entre ellos y con la Red y ofrecerán datos en tiempo real. O dicho de<br> 
otro modo, se acerca la digitalización del mundo físico. 

<br><br><br>
<H3>MECATRÓNICA</H3>
A grandes rasgos te puedo decir que se trata de un área multidisciplinaria<br>
originalmente integrada por tres áreas del conocimiento, Ing. Mecánica,<br> 
ing. Electrónica y ing. en computación, con el avance de la tecnología se<br>
han creado nuevas áreas que a su vez se han integrado a la definición de mecatrónica.

<br><br><br>
<H3>3D PRINTING</H3>
Las impresoras 3D no pueden utilizar cualquier material, hay una gran variedad para<br>
su impresión, como: transparentes, de colores, opacos, flexibles, rígidos, de alta<br>
temperatura y resistencia. Este tipo de materiales satisfacen necesidades de manera<br>
visual y táctil, además, son muy resistentes y con la fuerza necesaria que los<br>
prototipos requieren. 
